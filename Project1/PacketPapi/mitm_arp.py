...
def main(in_victim_ip, in_victim_mac, in_spoofed_ip_origin, in_spoofed_mac_origin, in_attacker_mac):
  ...
  try:
    ...
    restore_arp(in_victim_ip, in_victim_mac, in_spoofed_ip_origin, in_spoofed_mac_origin, in_attacker_mac)  # Original spoofed_mac_here
    restore_arp(in_spoofed_ip_origin, in_spoofed_mac_origin, in_victim_ip, in_victim_mac, in_attacker_mac)   # Original victim_mac_here
